...
using namespace winrt::AppServiceSample;
using namespace winrt::AppServiceSample::implementation;
...
App::App() noexcept
{
    ...
    PackageProviders().Append(winrt::ServiceChannel::ReactPackageProvider());
...
void App::OnLaunched(activation::LaunchActivatedEventArgs const& e)
{
    ...
    rootFrame.Navigate(xaml_typename<AppServiceSample::MainPage>(), box_value(e.Arguments()));
}
